...
本目录存放使用 ZERO 框架时的参考实现文档，包括通用组件和页面模板。

> **与 standards 的区别**：
> - `standards/` - 框架基础规范（命名、结构、代码风格等）
> - `references/` - 组件/功能参考（具体实现细节、使用示例）

---

## 通用表格组件 (DatabaseTable)

核心 CRUD 组件，自动读取数据库表结构生成表格。

| 文档 | 说明 |
|------|------|
| [database-table-01.overview.md](database-table-01.overview.md) | 概述与架构 |
...
| 文档 | 说明 |
|------|------|
| [manifest-admin.md](manifest-admin.md) | Manifest 管理页面 |
